...
<%  
    ...
    int pmtid=1;//Integer.parseInt(request.getParameter("pmtid"));
...
<%	Connection con=null;
	...
	try {
		...
		if(rs.next())
			...
			pmtid=1;
		cmd="INSERT INTO APSFC_PAYMENT(PAYMENT_ID,LOAN_NO,PAYMENT_AMOUNT,PAYMENT_DATE ,DD_NO) VALUES(?,?,?,?,?)";
        ...
        out.println("<link rel=stylesheet href='dyn.xsl'><body bgcolor=gray><h1>Your Transaction is Succeeded</h1><br><h1>Your PAYMENT ID is " + pmtid + "</h1><br><br><center><a href=\"javascript:history.back()\">Continue</a>&nbsp;&nbsp;<a href=\"index.htm\" target=\"_parent\">Home</a>");
	    }catch(Exception e)	{
			String msgs=" ";
